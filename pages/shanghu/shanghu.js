var newsData = require("../data_uselist1/data_uselist1.js")
var iteData = require("../data_pj1/data_pj1.js")
var initData = require("../data_pay1/data_pay1.js")
Page({
...
// 判断，如果newsid=3。说明点击的是待评价. 那么将currentTab也改为3.相当于待评价页面
  ...
  listcontent:function () {
    wx.navigateTo({
      url: '/pages/dpj_daisy1/dpj_daisy1',
    })
  },
  ...
  gopay:function () {
    wx.navigateTo({
      url: '/pages/DFK_xiangqing1/DFK_xiangqing1',
    })
  },
